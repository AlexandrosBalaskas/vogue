...
const article: {
  ...
  content: [
    {
      type: "paragraph",
      text: `Lately, I have been thinking a lot about what power means today, and who actually holds it. Reduced to its simplest form, power today comes from knowledge, information, but above all from the ability to hold someone’s attention. That is why the media, in any format, still shape the world we live in. And yet, there are also those who neither seek attention nor chase it, contemporary gods of attention who keep us locked in the same focus for years, without any need to adapt to the rhythm of the moment. A classmate of mine wrote her entire final thesis about him, I have the feeling my boyfriend vanished off the face of the earth every time he picked up one of his novels, and my family home has for years looked like a little shrine, all of his books lined up in order, from the first to the last.

      When he came to Belgrade last year for one of the crime fiction conventions, the city reacted as if we had gone back to the 1980s — the arrival of a global rock star quietly stirring the entire social scene. And perhaps that is exactly why his presence never feels confined to the page. Earlier this year, during a brief stay in Athens, he was meeting readers in a place where the line moved slowly and the atmosphere carried a quiet kind of anticipation — the kind you only really notice if you are standing there yourself. Watching it unfold, one moment lingered. A girl with striking red curls stepped forward. There was nothing remarkable in the exchange — a book, a few words — and yet something in that brief pause felt just slightly out of rhythm, as if time held for a second longer than it should have. And yes, in case it is not clear by now, I finally have a perfectly valid reason to reopen the story of Jo Nesbø.
...
When the story shifts to the present day, five years after the accident, everything seems calm. Harry is sober, happy, and in love with his Rakel Fauke (Pia Tjelta). Oleg is still a boy, longing for a father figure. Harry introduces him to the Ramones, chases away his fears, understands him, and the two bring out the best in each other. And just when everything seems to be in place, beautiful Elen, Harry’s colleague and one of the few people he loves and respects, dies under suspicious circumstances while on duty. That is when the curtain falls. Hole returns to all of his vices, pushes everyone away, and remains alone at rock bottom, unable to work or pull himself out of his darkness.`,
    ...
    {
      type: "paragraph",
      text: `Parallel to his physical and emotional unraveling, a serial killer leaves behind a string of ritualistic, religiously motivated murders that provoke and confuse the police. Harry balances between his addiction and his passion for solving difficult cases as he pieces together the killer’s profile. It is tempting to believe that inspiration comes only from darkness, from trauma, from the depths that Harry himself so often inhabits. And yet, Nesbø has always written with an eye for contrast — for the quiet, almost imperceptible moments that disrupt that darkness, the kind that, perhaps like the one glimpsed in Athens, find their way into the emotional fabric of his work. It was only later, almost in passing, that the detail surfaced — the name written on the page he signed: Maria Bella. At the same time, his hated rival and colleague Tom Waaler is breathing down his neck and digging into fresh wounds: from Elen, to his collapse into alcoholism, to his breakup with Rakel and growing distance from Oleg, all the way to losing his job and the last hope that work might once again pull him back to the surface.
